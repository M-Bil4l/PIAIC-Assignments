...
const arr2:number[] = [10,20,33,16,18,55,21,31,65];
...
const arr3:number[] = [10,20,33,16,18,55,21,31,65,67,77];
...
const grades: number[] = [90, 80, 70, 60, 50, 40, 30, 20, 10];
...
const arr4:number[] = [10,20,33,16,18,55,21,313,65,67,77,78,44];
...
let lg:number = largestNumber(arr4)
console.log(lg);
