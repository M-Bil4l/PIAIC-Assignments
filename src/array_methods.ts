...
const arrayNumber:number[] = [33,-44,-56,-66,32,99]

let positiveArray:number[] = arrayNumber.filter((num)=>{
    if(num>=0)
    console.log(num);
...
const celciusArray:number[] = [0, 10, 20, 30, 40]
...
const nameArray:string[] =  ["Alice", "Bob", "Charlie", "David", "Emily"]

// const updatedArray = nameArray.forEach(name => console.log(`${name}!`))

const nameWithExclamation:string[] = []
