...
var tempInCelcius:number = 37;
var conversionInFahrenheit:number = (tempInCelcius * 9/5) + 32;
console.log(`${tempInCelcius} celcius is equal to ${conversionInFahrenheit} fahrenheit.`);
 ...
 var tempInFahrenheit:number = 99;
 var conversionInCelcius:number = (tempInFahrenheit - 32) * 5/9 ;
...
var unitConsumed:number = 110;
var perUnitPrice:number = 25;
var electricityBill:number = unitConsumed * perUnitPrice;
if(unitConsumed > 100)
{
    let billAfterTax:number = electricityBill*10/100;
    electricityBill = electricityBill + billAfterTax
    console.log(electricityBill)
}
else if(unitConsumed > 200)
{
    let billAfterTax:number = electricityBill*15/100;
    electricityBill = electricityBill + billAfterTax
    console.log(electricityBill)
}
...
{
    let billAfterTax:number = electricityBill*20/100;
    electricityBill = electricityBill + billAfterTax
    console.log(electricityBill)
}
...
{
    let billAfterTax:number = electricityBill*25/100;
    electricityBill = electricityBill + billAfterTax
    console.log(electricityBill)
}
...
{
    let billAfterTax:number = electricityBill*30/100;
    electricityBill = electricityBill + billAfterTax
    console.log(electricityBill)
}
...
var amountToCalculate:number = 20000
var percentagevalue:number = 10000
var resultOfPercentage:number = percentagevalue/amountToCalculate * 100;
...
if(productPrice > 100){
    ...
    var discountedPrice10:number = productPrice/100*10;
    var finalPrice:number = productPrice - discountedPrice10
...
else 
{
    ...
    var discountedPrice10:number = productPrice/100*5;
    var finalPrice:number = productPrice - discountedPrice10
    console.log(finalPrice)
}
...
var numberOfDays:number = 15
var numberOfWeeks:number = Math.floor(numberOfDays/7)
var remainingDays:number = numberOfDays%7
